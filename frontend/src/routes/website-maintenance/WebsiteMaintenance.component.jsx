      ...
      <div className='website-maintenance-container'>
        <div className='website-maintenance-text'>
          <p>
            ...
            customers, new and existing, will learn about what you have to offer
            and decide if they will spend their hard-earned money. Failure to
            maintain your website may leave the impression that your business is
            no longer "doing business" and irrelevant. This results in loss of
            search engine visibility, customers, and revenue.
          </p>
          <p>
            ...
            we make sure it stays that way so you can focus on what's important
