      ...
      <Carousel interval={7300} fade>
        ...
        <Carousel.Item>
          <img
            ...
            srcSet={`${DigitalMarketing344w} 344w, ${DigitalMarketing687w} 687w, ${DigitalMarketing1359w} 1359w, ${DigitalMarketing2479w} 2479w `}
        ...
        <Carousel.Item>
          <img
            ...
            srcSet={`${SheratonHotel344w} 344w, ${SheratonHotel687w} 687w, ${SheratonHotel1359w} 1359w, ${SheratonHotel2479w} 2479w `}
            sizes='(min-width: 425px) 344px, (min-width: 768px) 687px, (min-width: 1024px) 1359px, (min-width: 2560px) 2479px'
            alt='Third slide'
          />
